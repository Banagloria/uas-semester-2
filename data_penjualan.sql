...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Bulan Mei 2023 pada 14.04
...
--
ALTER TABLE `penjualan`
  ADD CONSTRAINT `penjualan_ibfk_1` FOREIGN KEY (`kategori_nama`) REFERENCES `kategori` (`nama_kategori`) ON UPDATE CASCADE;
COMMIT;
